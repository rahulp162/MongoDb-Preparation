...
//Question-1: Retrieve products with a "high-performance" tag and show the text score metadata for the matching tag
db.products.createIndex({ tags: "text", productName: "text" })
db.products.find(
  {
...
//Question-2: Retrieve all products in the "Electronics" category, showing the text score for matching the category
...
//Question-3: Retrieve products with a discountedPrice and show the metadata score for the price filter.
db.products.createIndex({ productName: "text", tags: "text" })
db.products.find({
...
//Question-4: Retrieve products with tags containing "wireless" and show the metadata score based on matching the tag.
...
//Question-5: Retrieve products with a warranty of "2 years" and show the metadata score related to the warranty field.
db.products.createIndex({warranty:"text"})
db.products.find({
  $text:{
    $search:"2 years"
  }
